...
def main(args):
    ...
    #react_set_df = react_set_df[react_set_df.RXN_ID == 'MAR03811']
    ...
    for treatment in treatments:
        ...
        for idx, rxn in react_set_df.iterrows():
            ...
            for pair in rxn['Measured_Product_Substrate_Pair']:
                #if(rxn['RXN_ID'] == 'MAR03811'):
                #    print('pair', pair, 'study_change_df[hmdb_product]', study_change_df[hmdb_product], 'study_change_df[hmdb_substrate]', study_change_df[hmdb_substrate])
